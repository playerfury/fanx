...
func init() {
	proto.RegisterType((*Phase)(nil), "furyx.furyx.mint.Phase")
}

func init() { proto.RegisterFile("furyx/mint/phase.proto", fileDescriptor_7fc2241b526dba74) }
