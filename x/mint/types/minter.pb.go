...
// source: furyx/mint/minter.proto
...
func init() {
	proto.RegisterType((*Minter)(nil), "furyx.furyx.mint.Minter")
}

func init() { proto.RegisterFile("furyx/mint/minter.proto", fileDescriptor_d31ed0ee2430eeec) }
