...
import (
	...
	"github.com/playerfury/fanx/x/mint/keeper"
	furyxMintTypes "github.com/playerfury/fanx/x/mint/types"
...
func BeginBlocker(ctx sdk.Context, k keeper.Keeper) {
	...
	ctx.EventManager().EmitEvent(
		sdk.NewEvent(
			...
			sdk.NewAttribute(furyxMintTypes.AttributeKeyPhaseProvisions, minter.PhaseProvisions.String()),
