...
// source: fanx/orderbook/orderbook.proto
...
type OrderBook struct {
	...
	// order book status
	Status OrderBookStatus `protobuf:"varint,4,opt,name=status,proto3,enum=playerfury.fanx.orderbook.OrderBookStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("playerfury.fanx.orderbook.OrderBookStatus", OrderBookStatus_name, OrderBookStatus_value)
	proto.RegisterType((*OrderBook)(nil), "playerfury.fanx.orderbook.OrderBook")
}

func init() { proto.RegisterFile("fanx/orderbook/orderbook.proto", fileDescriptor_7247ccc164993ca5) }
