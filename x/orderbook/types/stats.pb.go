...
// source: fanx/orderbook/stats.proto
...
func init() {
	proto.RegisterType((*OrderBookStats)(nil), "playerfury.fanx.orderbook.OrderBookStats")
}

func init() { proto.RegisterFile("fanx/orderbook/stats.proto", fileDescriptor_bbf84578c9c8bd09) }
