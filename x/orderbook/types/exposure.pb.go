...
// source: fanx/orderbook/exposure.proto
...
func init() {
	proto.RegisterType((*BookOddsExposure)(nil), "playerfury.fanx.orderbook.BookOddsExposure")
	proto.RegisterType((*ParticipationExposure)(nil), "playerfury.fanx.orderbook.ParticipationExposure")
}

func init() { proto.RegisterFile("fanx/orderbook/exposure.proto", fileDescriptor_3aa5f8fec7488c62) }
