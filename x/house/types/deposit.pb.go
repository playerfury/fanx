...
// source: furyx/house/deposit.proto
...
func init() {
	proto.RegisterType((*Deposit)(nil), "furyx.furyx.house.Deposit")
}

func init() { proto.RegisterFile("furyx/house/deposit.proto", fileDescriptor_c6f2840908fc45a1) }
