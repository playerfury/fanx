...
type Withdrawal struct {
	...
	Mode WithdrawalMode `protobuf:"varint,5,opt,name=mode,proto3,enum=playerfury.fanx.house.WithdrawalMode" json:"mode,omitempty" yaml:"mode"`
...
func init() {
	proto.RegisterEnum("playerfury.fanx.house.WithdrawalMode", WithdrawalMode_name, WithdrawalMode_value)
	proto.RegisterType((*Withdrawal)(nil), "playerfury.fanx.house.Withdrawal")
}

func init() { proto.RegisterFile("fanx/house/withdraw.proto", fileDescriptor_9ca852402ebf549d) }
