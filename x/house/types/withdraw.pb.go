...
// source: furyx/house/withdraw.proto
...
type Withdrawal struct {
	...
	Mode WithdrawalMode `protobuf:"varint,5,opt,name=mode,proto3,enum=furyx.furyx.house.WithdrawalMode" json:"mode,omitempty" yaml:"mode"`
...
func init() {
	proto.RegisterEnum("furyx.furyx.house.WithdrawalMode", WithdrawalMode_name, WithdrawalMode_value)
	proto.RegisterType((*Withdrawal)(nil), "furyx.furyx.house.Withdrawal")
}

func init() { proto.RegisterFile("furyx/house/withdraw.proto", fileDescriptor_9ca852402ebf549d) }
