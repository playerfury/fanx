...
type Withdrawal struct {
	...
	Mode WithdrawalMode `protobuf:"varint,5,opt,name=mode,proto3,enum=fanx.fanx.house.WithdrawalMode" json:"mode,omitempty" yaml:"mode"`
...
func init() {
	proto.RegisterEnum("fanx.fanx.house.WithdrawalMode", WithdrawalMode_name, WithdrawalMode_value)
	proto.RegisterType((*Withdrawal)(nil), "fanx.fanx.house.Withdrawal")
}
