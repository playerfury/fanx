...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "playerfury.fanx.house.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "playerfury.fanx.house.QueryParamsResponse")
	proto.RegisterType((*QueryDepositsRequest)(nil), "playerfury.fanx.house.QueryDepositsRequest")
	proto.RegisterType((*QueryDepositsResponse)(nil), "playerfury.fanx.house.QueryDepositsResponse")
	proto.RegisterType((*QueryDepositorDepositsRequest)(nil), "playerfury.fanx.house.QueryDepositorDepositsRequest")
	proto.RegisterType((*QueryDepositorDepositsResponse)(nil), "playerfury.fanx.house.QueryDepositorDepositsResponse")
	proto.RegisterType((*QueryDepositorWithdrawalsRequest)(nil), "playerfury.fanx.house.QueryDepositorWithdrawalsRequest")
	proto.RegisterType((*QueryDepositorWithdrawalsResponse)(nil), "playerfury.fanx.house.QueryDepositorWithdrawalsResponse")
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.fanx.house.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Deposits(ctx context.Context, in *QueryDepositsRequest, opts ...grpc.CallOption) (*QueryDepositsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.fanx.house.Query/Deposits", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DepositorDeposits(ctx context.Context, in *QueryDepositorDepositsRequest, opts ...grpc.CallOption) (*QueryDepositorDepositsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.fanx.house.Query/DepositorDeposits", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DepositorWithdrawals(ctx context.Context, in *QueryDepositorWithdrawalsRequest, opts ...grpc.CallOption) (*QueryDepositorWithdrawalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playerfury.fanx.house.Query/DepositorWithdrawals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.fanx.house.Query/Params",
	}
...
func _Query_Deposits_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.fanx.house.Query/Deposits",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DepositorDeposits_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.fanx.house.Query/DepositorDeposits",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DepositorWithdrawals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playerfury.fanx.house.Query/DepositorWithdrawals",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "playerfury.fanx.house.Query",
