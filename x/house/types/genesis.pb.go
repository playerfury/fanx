...
// source: furyx/house/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furyx.furyx.house.GenesisState")
}

func init() { proto.RegisterFile("furyx/house/genesis.proto", fileDescriptor_aa4dcd3bb98435db) }
