...
func init() {
	proto.RegisterType((*GenesisState)(nil), "playerfury.fanx.house.GenesisState")
}

func init() { proto.RegisterFile("fanx/house/genesis.proto", fileDescriptor_aa4dcd3bb98435db) }
