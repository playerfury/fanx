...
// source: fanx/sportevent/ticket.proto
...
type SportEventAddTicketPayload struct {
	...
	Status SportEventStatus `protobuf:"varint,5,opt,name=status,proto3,enum=playerfury.fanx.sportevent.SportEventStatus" json:"status,omitempty"`
...
type SportEventUpdateTicketPayload struct {
	...
	Status SportEventStatus `protobuf:"varint,6,opt,name=status,proto3,enum=playerfury.fanx.sportevent.SportEventStatus" json:"status,omitempty"`
}
...
type SportEventResolutionTicketPayload struct {
	...
	// status is the status of the resolution.
	Status SportEventStatus `protobuf:"varint,4,opt,name=status,proto3,enum=playerfury.fanx.sportevent.SportEventStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*SportEventAddTicketPayload)(nil), "playerfury.fanx.sportevent.SportEventAddTicketPayload")
	proto.RegisterType((*SportEventUpdateTicketPayload)(nil), "playerfury.fanx.sportevent.SportEventUpdateTicketPayload")
	proto.RegisterType((*SportEventResolutionTicketPayload)(nil), "playerfury.fanx.sportevent.SportEventResolutionTicketPayload")
}

func init() { proto.RegisterFile("fanx/sportevent/ticket.proto", fileDescriptor_b7e970e0fce71fcc) }
