...
// source: fanx/sportevent/sport_event.proto
...
func init() {
	proto.RegisterEnum("playerfury.fanx.sportevent.SportEventStatus", SportEventStatus_name, SportEventStatus_value)
	proto.RegisterType((*SportEvent)(nil), "playerfury.fanx.sportevent.SportEvent")
	proto.RegisterType((*EventBetConstraints)(nil), "playerfury.fanx.sportevent.EventBetConstraints")
}

func init() { proto.RegisterFile("fanx/sportevent/sport_event.proto", fileDescriptor_f4c38f73099259f8) }
