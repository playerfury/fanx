...
// source: fanx/sportevent/odds.proto
...
func init() {
	proto.RegisterType((*Odds)(nil), "playerfury.fanx.sportevent.Odds")
}

func init() { proto.RegisterFile("fanx/sportevent/odds.proto", fileDescriptor_c4eaa1643bcc33f0) }
