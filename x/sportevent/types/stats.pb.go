...
// source: fanx/sportevent/stats.proto
...
func init() {
	proto.RegisterType((*SportEventStats)(nil), "playerfury.fanx.sportevent.SportEventStats")
}

func init() { proto.RegisterFile("fanx/sportevent/stats.proto", fileDescriptor_bc09ed4418b895cc) }
