...
// source: furyx/market/ticket.proto
...
type MarketAddTicketPayload struct {
	...
	Status MarketStatus `protobuf:"varint,5,opt,name=status,proto3,enum=furyx.furyx.market.MarketStatus" json:"status,omitempty"`
...
type MarketUpdateTicketPayload struct {
	...
	Status MarketStatus `protobuf:"varint,6,opt,name=status,proto3,enum=furyx.furyx.market.MarketStatus" json:"status,omitempty"`
}
...
type MarketResolutionTicketPayload struct {
	...
	// status is the status of the resolution.
	Status MarketStatus `protobuf:"varint,4,opt,name=status,proto3,enum=furyx.furyx.market.MarketStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*MarketAddTicketPayload)(nil), "furyx.furyx.market.MarketAddTicketPayload")
	proto.RegisterType((*MarketUpdateTicketPayload)(nil), "furyx.furyx.market.MarketUpdateTicketPayload")
	proto.RegisterType((*MarketResolutionTicketPayload)(nil), "furyx.furyx.market.MarketResolutionTicketPayload")
}

func init() { proto.RegisterFile("furyx/market/ticket.proto", fileDescriptor_1dc46cd902954700) }
