...
// source: furyx/market/stats.proto
...
func init() {
	proto.RegisterType((*MarketStats)(nil), "furyx.furyx.market.MarketStats")
}

func init() { proto.RegisterFile("furyx/market/stats.proto", fileDescriptor_ee763120d9ee1c76) }
