...
// source: furyx/market/odds.proto
...
func init() {
	proto.RegisterType((*Odds)(nil), "furyx.furyx.market.Odds")
}

func init() { proto.RegisterFile("furyx/market/odds.proto", fileDescriptor_cf7f1000ed50889d) }
