...
// source: furyx/market/market.proto
...
func init() {
	proto.RegisterEnum("furyx.furyx.market.MarketStatus", MarketStatus_name, MarketStatus_value)
	proto.RegisterType((*Market)(nil), "furyx.furyx.market.Market")
	proto.RegisterType((*MarketBetConstraints)(nil), "furyx.furyx.market.MarketBetConstraints")
}

func init() { proto.RegisterFile("furyx/market/market.proto", fileDescriptor_935a8ad1d6bee065) }
