...
func init() {
	proto.RegisterType((*MsgAddMarket)(nil), "furyx.furyx.market.MsgAddMarket")
	proto.RegisterType((*MsgAddMarketResponse)(nil), "furyx.furyx.market.MsgAddMarketResponse")
	proto.RegisterType((*MsgResolveMarket)(nil), "furyx.furyx.market.MsgResolveMarket")
	proto.RegisterType((*MsgResolveMarketResponse)(nil), "furyx.furyx.market.MsgResolveMarketResponse")
	proto.RegisterType((*MsgUpdateMarket)(nil), "furyx.furyx.market.MsgUpdateMarket")
	proto.RegisterType((*MsgUpdateMarketResponse)(nil), "furyx.furyx.market.MsgUpdateMarketResponse")
}

func init() { proto.RegisterFile("furyx/market/tx.proto", fileDescriptor_d0e875658c4f19fd) }
...
func (c *msgClient) AddMarket(ctx context.Context, in *MsgAddMarket, opts ...grpc.CallOption) (*MsgAddMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyx.furyx.market.Msg/AddMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ResolveMarket(ctx context.Context, in *MsgResolveMarket, opts ...grpc.CallOption) (*MsgResolveMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyx.furyx.market.Msg/ResolveMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateMarket(ctx context.Context, in *MsgUpdateMarket, opts ...grpc.CallOption) (*MsgUpdateMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyx.furyx.market.Msg/UpdateMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyx.furyx.market.Msg/AddMarket",
	}
...
func _Msg_ResolveMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyx.furyx.market.Msg/ResolveMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyx.furyx.market.Msg/UpdateMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyx.furyx.market.Msg",
	...
	Metadata: "furyx/market/tx.proto",
}
