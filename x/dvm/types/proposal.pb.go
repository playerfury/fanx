...
type PublicKeysChangeFinishedProposal struct {
	...
	Result ProposalResult `protobuf:"varint,2,opt,name=result,proto3,enum=playerfury.fanx.dvm.ProposalResult" json:"result,omitempty"`
...
func init() {
	proto.RegisterEnum("playerfury.fanx.dvm.ProposalResult", ProposalResult_name, ProposalResult_value)
	proto.RegisterType((*PublicKeysChangeProposal)(nil), "playerfury.fanx.dvm.PublicKeysChangeProposal")
	proto.RegisterType((*PublicKeysChangeFinishedProposal)(nil), "playerfury.fanx.dvm.PublicKeysChangeFinishedProposal")
}
