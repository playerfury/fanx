...
// source: furyx/dvm/proposal.proto
...
type PublicKeysChangeProposal struct {
	...
	Result ProposalResult `protobuf:"varint,6,opt,name=result,proto3,enum=furyx.furyx.dvm.ProposalResult" json:"result,omitempty"`
	...
	Status ProposalStatus `protobuf:"varint,9,opt,name=status,proto3,enum=furyx.furyx.dvm.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("furyx.furyx.dvm.ProposalResult", ProposalResult_name, ProposalResult_value)
	proto.RegisterEnum("furyx.furyx.dvm.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*PublicKeysChangeProposal)(nil), "furyx.furyx.dvm.PublicKeysChangeProposal")
}

func init() { proto.RegisterFile("furyx/dvm/proposal.proto", fileDescriptor_29058a11b4a243d6) }
