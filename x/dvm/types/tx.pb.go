...
func init() {
	proto.RegisterType((*MsgSubmitPubkeysChangeProposalRequest)(nil), "furyx.furyx.dvm.MsgSubmitPubkeysChangeProposalRequest")
	proto.RegisterType((*MsgSubmitPubkeysChangeProposalResponse)(nil), "furyx.furyx.dvm.MsgSubmitPubkeysChangeProposalResponse")
	proto.RegisterType((*MsgVotePubkeysChangeRequest)(nil), "furyx.furyx.dvm.MsgVotePubkeysChangeRequest")
	proto.RegisterType((*MsgVotePubkeysChangeResponse)(nil), "furyx.furyx.dvm.MsgVotePubkeysChangeResponse")
}

func init() { proto.RegisterFile("furyx/dvm/tx.proto", fileDescriptor_78e7f1885428b6a5) }
...
func (c *msgClient) SubmitPubkeysChangeProposal(ctx context.Context, in *MsgSubmitPubkeysChangeProposalRequest, opts ...grpc.CallOption) (*MsgSubmitPubkeysChangeProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyx.furyx.dvm.Msg/SubmitPubkeysChangeProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) VotePubkeysChange(ctx context.Context, in *MsgVotePubkeysChangeRequest, opts ...grpc.CallOption) (*MsgVotePubkeysChangeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyx.furyx.dvm.Msg/VotePubkeysChange", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitPubkeysChangeProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyx.furyx.dvm.Msg/SubmitPubkeysChangeProposal",
	}
...
func _Msg_VotePubkeysChange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyx.furyx.dvm.Msg/VotePubkeysChange",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyx.furyx.dvm.Msg",
