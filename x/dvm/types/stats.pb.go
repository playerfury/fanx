...
func init() {
	proto.RegisterType((*ProposalStats)(nil), "furyx.furyx.dvm.ProposalStats")
}

func init() { proto.RegisterFile("furyx/dvm/stats.proto", fileDescriptor_18b1583139df99d6) }
