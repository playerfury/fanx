...
func init() {
	proto.RegisterType((*PubkeysChangeProposalPayload)(nil), "playerfury.fanx.dvm.PubkeysChangeProposalPayload")
	proto.RegisterType((*ProposalVotePayload)(nil), "playerfury.fanx.dvm.ProposalVotePayload")
}
