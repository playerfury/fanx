...
type Vote struct {
	...
	Vote ProposalVote `protobuf:"varint,2,opt,name=vote,proto3,enum=playerfury.fanx.dvm.ProposalVote" json:"vote,omitempty"`
}
...
func init() {
	proto.RegisterEnum("playerfury.fanx.dvm.ProposalVote", ProposalVote_name, ProposalVote_value)
	proto.RegisterType((*Vote)(nil), "playerfury.fanx.dvm.Vote")
}

func init() { proto.RegisterFile("fanx/dvm/vote.proto", fileDescriptor_c881d83c5c5286a5) }
