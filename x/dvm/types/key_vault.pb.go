...
// source: furyx/dvm/key_vault.proto
...
func init() {
	proto.RegisterType((*KeyVault)(nil), "furyx.furyx.dvm.KeyVault")
}

func init() { proto.RegisterFile("furyx/dvm/key_vault.proto", fileDescriptor_a21a2d7ce8c462b6) }
