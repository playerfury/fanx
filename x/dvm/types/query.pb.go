...
type QueryPublicKeysChangeProposalRequest struct {
	...
	Status ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=furyx.furyx.dvm.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "furyx.furyx.dvm.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "furyx.furyx.dvm.QueryParamsResponse")
	proto.RegisterType((*QueryPubKeysRequest)(nil), "furyx.furyx.dvm.QueryPubKeysRequest")
	proto.RegisterType((*QueryPubKeysResponse)(nil), "furyx.furyx.dvm.QueryPubKeysResponse")
	proto.RegisterType((*QueryPublicKeysChangeProposalRequest)(nil), "furyx.furyx.dvm.QueryPublicKeysChangeProposalRequest")
	proto.RegisterType((*QueryPublicKeysChangeProposalResponse)(nil), "furyx.furyx.dvm.QueryPublicKeysChangeProposalResponse")
	proto.RegisterType((*QueryPublicKeysChangeProposalsRequest)(nil), "furyx.furyx.dvm.QueryPublicKeysChangeProposalsRequest")
	proto.RegisterType((*QueryPublicKeysChangeProposalsResponse)(nil), "furyx.furyx.dvm.QueryPublicKeysChangeProposalsResponse")
}

func init() { proto.RegisterFile("furyx/dvm/query.proto", fileDescriptor_cfb9990f7b27fb76) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyx.furyx.dvm.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PubKeys(ctx context.Context, in *QueryPubKeysRequest, opts ...grpc.CallOption) (*QueryPubKeysResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyx.furyx.dvm.Query/PubKeys", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PublicKeysChangeProposal(ctx context.Context, in *QueryPublicKeysChangeProposalRequest, opts ...grpc.CallOption) (*QueryPublicKeysChangeProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyx.furyx.dvm.Query/PublicKeysChangeProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PublicKeysChangeProposals(ctx context.Context, in *QueryPublicKeysChangeProposalsRequest, opts ...grpc.CallOption) (*QueryPublicKeysChangeProposalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furyx.furyx.dvm.Query/PublicKeysChangeProposals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyx.furyx.dvm.Query/Params",
	}
...
func _Query_PubKeys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyx.furyx.dvm.Query/PubKeys",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PublicKeysChangeProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyx.furyx.dvm.Query/PublicKeysChangeProposal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PublicKeysChangeProposals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furyx.furyx.dvm.Query/PublicKeysChangeProposals",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furyx.furyx.dvm.Query",
	...
	Metadata: "furyx/dvm/query.proto",
}
