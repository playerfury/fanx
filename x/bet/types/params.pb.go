...
func init() {
	proto.RegisterType((*Params)(nil), "furyx.furyx.bet.Params")
}

func init() { proto.RegisterFile("furyx/bet/params.proto", fileDescriptor_4216d2638a14c9d3) }
