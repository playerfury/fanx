...
type BetPlacementTicketPayload struct {
	...
	OddsType OddsType `protobuf:"varint,3,opt,name=odds_type,json=oddsType,proto3,enum=playerfury.fanx.bet.OddsType" json:"odds_type,omitempty"`
}
...
func init() {
	proto.RegisterType((*BetPlacementTicketPayload)(nil), "playerfury.fanx.bet.BetPlacementTicketPayload")
}

func init() { proto.RegisterFile("fanx/bet/ticket.proto", fileDescriptor_cf6959e7db451613) }
