...
type BetPlacementTicketPayload struct {
	...
	OddsType OddsType `protobuf:"varint,3,opt,name=odds_type,json=oddsType,proto3,enum=fanx.fanx.bet.OddsType" json:"odds_type,omitempty"`
}
...
func init() {
	proto.RegisterType((*BetPlacementTicketPayload)(nil), "fanx.fanx.bet.BetPlacementTicketPayload")
}
