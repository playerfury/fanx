...
type BetPlacementTicketPayload struct {
	...
	OddsType OddsType `protobuf:"varint,3,opt,name=odds_type,json=oddsType,proto3,enum=furyx.furyx.bet.OddsType" json:"odds_type,omitempty"`
}
...
func init() {
	proto.RegisterType((*BetPlacementTicketPayload)(nil), "furyx.furyx.bet.BetPlacementTicketPayload")
}

func init() { proto.RegisterFile("furyx/bet/ticket.proto", fileDescriptor_cf6959e7db451613) }
