...
func init() {
	proto.RegisterType((*BetStats)(nil), "furyx.furyx.bet.BetStats")
}

func init() { proto.RegisterFile("furyx/bet/stats.proto", fileDescriptor_e7bd589ff6fa2d86) }
