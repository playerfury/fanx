...
// source: furyx/bet/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furyx.furyx.bet.GenesisState")
}

func init() { proto.RegisterFile("furyx/bet/genesis.proto", fileDescriptor_6c49ebc0f2678a09) }
