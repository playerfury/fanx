...
func init() {
	proto.RegisterType((*KycDataPayload)(nil), "furyx.furyx.bet.KycDataPayload")
}

func init() { proto.RegisterFile("furyx/bet/kyc.proto", fileDescriptor_13abc80c3002dbc4) }
