...
func init() {
	proto.RegisterType((*KycDataPayload)(nil), "playerfury.fanx.bet.KycDataPayload")
}

func init() { proto.RegisterFile("fanx/bet/kyc.proto", fileDescriptor_13abc80c3002dbc4) }
