...
// source: furyx/bet/odds_type.proto
...
func init() {
	proto.RegisterEnum("furyx.furyx.bet.OddsType", OddsType_name, OddsType_value)
}

func init() { proto.RegisterFile("furyx/bet/odds_type.proto", fileDescriptor_9054da535c81741c) }
