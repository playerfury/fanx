...
// source: furyx/bet/bet_odds.proto
...
func init() {
	proto.RegisterType((*BetOdds)(nil), "furyx.furyx.bet.BetOdds")
}

func init() { proto.RegisterFile("furyx/bet/bet_odds.proto", fileDescriptor_2629a03d0a23fb04) }
