...
type Bet struct {
	...
	OddsType OddsType `protobuf:"varint,4,opt,name=odds_type,json=oddsType,proto3,enum=playerfury.fanx.bet.OddsType" json:"odds_type,omitempty"`
	...
	Status Bet_Status `protobuf:"varint,8,opt,name=status,proto3,enum=playerfury.fanx.bet.Bet_Status" json:"status,omitempty"`
	// result is the result of the bet, such as `won` or `lost`.
	Result Bet_Result `protobuf:"varint,9,opt,name=result,proto3,enum=playerfury.fanx.bet.Bet_Result" json:"result,omitempty"`
...
func init() {
	proto.RegisterEnum("playerfury.fanx.bet.Bet_Status", Bet_Status_name, Bet_Status_value)
	proto.RegisterEnum("playerfury.fanx.bet.Bet_Result", Bet_Result_name, Bet_Result_value)
	proto.RegisterType((*Bet)(nil), "playerfury.fanx.bet.Bet")
	proto.RegisterType((*UID2ID)(nil), "playerfury.fanx.bet.UID2ID")
	proto.RegisterType((*ActiveBet)(nil), "playerfury.fanx.bet.ActiveBet")
	proto.RegisterType((*SettledBet)(nil), "playerfury.fanx.bet.SettledBet")
	proto.RegisterType((*BetFulfillment)(nil), "playerfury.fanx.bet.BetFulfillment")
}
