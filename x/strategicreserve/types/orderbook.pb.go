...
// source: furyx/strategicreserve/orderbook.proto
...
type OrderBook struct {
	...
	Status OrderBookStatus `protobuf:"varint,4,opt,name=status,proto3,enum=furyx.furyx.strategicreserve.OrderBookStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("furyx.furyx.strategicreserve.OrderBookStatus", OrderBookStatus_name, OrderBookStatus_value)
	proto.RegisterType((*OrderBook)(nil), "furyx.furyx.strategicreserve.OrderBook")
}

func init() {
	proto.RegisterFile("furyx/strategicreserve/orderbook.proto", fileDescriptor_fd759bf8b8b48f1e)
}
