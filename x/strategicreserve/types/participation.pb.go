...
// source: furyx/strategicreserve/participation.proto
...
func init() {
	proto.RegisterType((*OrderBookParticipation)(nil), "furyx.furyx.strategicreserve.OrderBookParticipation")
	proto.RegisterType((*ParticipationBetPair)(nil), "furyx.furyx.strategicreserve.ParticipationBetPair")
}

func init() {
	proto.RegisterFile("furyx/strategicreserve/participation.proto", fileDescriptor_ef2b931ff7c6f37b)
}
