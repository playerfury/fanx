...
// source: fanx/strategicreserve/sr_pool.proto
...
func init() {
	proto.RegisterType((*SRPool)(nil), "playerfury.fanx.strategicreserve.SRPool")
}

func init() {
	proto.RegisterFile("fanx/strategicreserve/sr_pool.proto", fileDescriptor_c939b57bb279fe3c)
}
