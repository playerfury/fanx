...
// source: fanx/strategicreserve/reserver.proto
...
func init() {
	proto.RegisterType((*Reserver)(nil), "playerfury.fanx.strategicreserve.Reserver")
}

func init() {
	proto.RegisterFile("fanx/strategicreserve/reserver.proto", fileDescriptor_a346a0fea33afb26)
}
